...
//     try {
//       const res = await API_UPDATE_BUILDING(selectedHouse.id, {
//         title: selectedHouse.title,
//         prioritized: selectedHouse.prioritized,
//       });
//       if (res.status === 200) {
//         toast.success("House updated successfully!");
//         setUpdateModal(false);
//         // Optionally, refetch or update the house list
//         const updatedHouses = houses.map(house => house.id === selectedHouse.id ? res.data : house);
//         setHouses(updatedHouses);
//         setFilteredRows(updatedHouses);
//       }
//     } catch (error) {
...
//         {updateModal && (
//   <Modal
//     className={"Auth-modal custom-modal-body3"}
//     show={updateModal}
//     centered
//     size='lg'
//   >
...
//       <Row className="d-flex justify-content-center mt-3">
//         <Col xs={6} md={4}>
//           <Button type="submit" onClick={handleUpdateHouse}>
//             به‌روزرسانی
//           </Button>
//         </Col>
//         <Col xs={6} md={4}>
